...
class subject5_list : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subject5_list)
    ...
    private fun getUserData() {
        ...
        dbref = FirebaseDatabase.getInstance().getReference("Attendance $year").child(monthName).child("Data science").child(date)
