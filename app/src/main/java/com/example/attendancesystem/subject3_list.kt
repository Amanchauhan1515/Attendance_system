...
class subject3_list : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subject3_list)
    ...
    private fun getUserData() {
        ...
        dbref = FirebaseDatabase.getInstance().getReference("Attendance $year").child(monthName).child("Web services").child(date)
