...
class subject1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subject1_list)
    ...
    private fun getUserData() {
        ...
        dbref = FirebaseDatabase.getInstance().getReference("Attendance $year").child(monthName).child("Linux administration").child(date)
