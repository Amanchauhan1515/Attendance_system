...
class subject4_list : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subject4_list)
    ...
    private fun getUserData() {
        ...
        dbref = FirebaseDatabase.getInstance().getReference("Attendance $year").child(monthName).child("Ethical hacking").child(date)
